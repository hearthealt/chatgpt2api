...
<p align="center"><strong>当前稳定版本：v1.0.1</strong> | <a href="https://github.com/hearthealt/chatgpt2api/releases/tag/v1.0.1">发布说明</a> | <a href="https://github.com/hearthealt/chatgpt2api/releases">全部版本</a></p>
...
```bash
curl -fsSL https://raw.githubusercontent.com/hearthealt/chatgpt2api/v1.0.1/deploy/install.sh | sudo bash -s -- --branch v1.0.1
```
